                ...
                return (
                  <tr key={e.id} className="hover:bg-slate-50">
                    <td className="td">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500">{e.nik}</p>
                        </div>
                      </div>
                    </td>
                    <td className="td">
                    ...
                    <td className="td">
                      ...
                      <p className="text-xs text-slate-400">{e.branch}</p>
                    </td>
                    <td className="td">
                    ...
                    <td className="td">
                      {e.npwp === "-" ? (
                        ...
                        <span className="text-xs text-slate-500">{e.npwp}</span>
                      )}
                    </td>
                    <td className="td">
                      <p className="text-slate-600">{e.bankName}</p>
                      <p className="text-xs text-slate-400">{e.bankAccount}</p>
                    </td>
                    <td className="td text-slate-500">{tanggal(e.joinDate)}</td>
                    <td className="td">
